...
# умножение (mul()), деление (truediv()). Данные методы должны применяться только к клеткам и выполнять увеличение, уменьшение,
...
class Cell:
    ...
    def __sub__(self, other):
        ...
        return f'Клетка стала меньше, она равна: {sub} клеткам' if sub > 0 else 'Клетки нет :('
